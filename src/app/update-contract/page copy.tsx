    ...
    try {
      ...
      await db.execute(
        `UPDATE contracts SET
          batch = ?, posting = ?, preBid = ?, bidding = ?,
          contractID = ?, projectName = ?, status = ?,
          contractAmount = ?, contractor = ?, bidEvalStart = ?,
          bidEvalEnd = ?, postQualStart = ?, postQualEnd = ?,
          reso = ?, noa = ?, ntp = ?, ntpRecieve = ?,
          contractDate = ?, lastUpdated = ?
        WHERE id = ?`, // Use ? for placeholders
        [
          ...
          updatedContract.id, // The last ? corresponds to the WHERE clause
        ]
      );
