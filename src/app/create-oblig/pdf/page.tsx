  ...
  return (
    <div>
      <div
        id="printable"
        ref={contentRef}
        className="w-full h-full tahoma text-center bg-white"  
      >
        {/* Header Section */}
        <div className="flex justify-between items-center p-14 pb-0 mb-[22px]">
          ...
          <div className="text-[14px] text-black">
            ...
            <p className="">DEPARTMENT OF PUBLIC WORKS AND HIGHWAYS</p>
      ...
      <button
        ...
        className="mt-20 mx-auto w-80 btn btn-neutral mb-10 print:hidden"
      >
        Print
      </button>
    </div>
